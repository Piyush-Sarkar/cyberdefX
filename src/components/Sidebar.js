...
const Sidebar = ({ isCollapsed, setIsCollapsed, userProfile }) => {
            ...
            {!isCollapsed && (
              <>
                <div className="user-info">
                  ...
                  {userProfile?.jobTitle && <span className="user-role">{userProfile.jobTitle}</span>}
                  {!userProfile?.fullName && !userProfile?.jobTitle && (
